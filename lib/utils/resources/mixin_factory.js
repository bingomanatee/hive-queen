...
/* ******* CLOSURE ********* */
var template_path = path.resolve(__dirname, './../../templates/mixin.js');
...
function  _handler(model_path, params, l) {
	var mixin_params = _.extend({name: params.key}, params.value);
	fs.writeFile(model_path,  handler(mixin_params), l);
}
/* ********* EXPORTS ******** */
